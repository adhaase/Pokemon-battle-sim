...
def trainer_party_selection(name) # conducts the Pokemon selection process and prints the 6 Pokemon the trainer has chosen
	pkmn_col = PokemonCollection.new
	...
	for x in 0..5 # there are 6 Pokemon in a Party
		...
		if (pokemon_num.to_i < 0 || pokemon_num.to_i > 7)
			...
			# TODO: make the Player re-enter an integer
		else 
